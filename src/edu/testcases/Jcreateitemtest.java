/**
 * Tests the ability of users to create their listings
 * 
 * Verifies by deleting listing
 */
...
public class Jcreateitemtest {
  ...
  @Test
  public void testJcreateitem() throws Exception {
    ...
    driver.findElement(By.name("description")).sendKeys("used.");
    Thread.sleep(3000);
